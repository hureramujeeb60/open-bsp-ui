        ...
        >
          <fieldset disabled={!isOwner} className="contents">
            <p className="text-muted-foreground text-[14px]">
              {t(
                "Generá un enlace para que un tercero conecte su número de WhatsApp a tu organización. No necesita tener cuenta en SocialConnect ni ser miembro de tu organización.",
              )}
            </p>
            ...
            <label>
              ...
              <div className="text-muted-foreground text-[12px] mt-[4px]">
                {t(
                  "Si la configurás, los webhooks de mensajes de esta cuenta se envían directo a tu app en vez de a SocialConnect.",
                )}
              </div>
            </label>
